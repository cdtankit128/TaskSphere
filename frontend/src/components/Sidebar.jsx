  ...
  return (
    <aside className="h-screen w-64 fixed left-0 top-0 bg-[#0b0e14] shadow-[0_0_32px_0_rgba(186,158,255,0.08)] flex flex-col py-8 z-50">
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              isActive
                ...
                : "flex items-center gap-3 px-4 py-3 text-[#ecedf6]/60 hover:text-[#ecedf6] hover:bg-[#22262f] rounded-r-full border-l-4 border-transparent transition-all duration-300"
            }
          >
      ...
      <div className="px-6 mt-auto space-y-4">
        <button className="w-full py-3 rounded-xl bg-gradient-to-br from-primary to-primary-dim text-on-primary font-bold shadow-[0_0_20px_rgba(186,158,255,0.2)] active:scale-95 transition-transform cursor-pointer">
          New Task
        </button>
